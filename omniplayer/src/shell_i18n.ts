...
const ZH: StringTable = {
  ...
  "notes.colorTemp.btnTitle": "色温与退格：只改你打的字（输入框、用户气泡、线索便签）",
  "notes.colorTemp.title": "色温与退格",
  "notes.colorTemp.desc":
    "按击键间隔给字上色：快偏暖红、慢偏冷蓝。退格过的字可显示为灰色。流式笔记作用于输入框和你发出的气泡；线索板作用于便签正文。助手回复不变。",
  "notes.colorTemp.toggle": "显示色温",
  "notes.colorTemp.toggleHint": "关则恢复普通墨色；字形仍会随发送落盘。",
  "notes.colorTemp.backspaceToggle": "显示退格",
  "notes.colorTemp.backspaceToggleHint": "开则把删掉的字显示为灰色；关则只看留下的字。字形仍会落盘。",
  ...
  "notes.clue.boards.renameHint": "双击重命名；Ctrl 多选，Shift 连选，Ctrl+A 全选；Esc 退出多选；右键详情或删除",
  ...
  "notes.clue.boards.tileMeta": "{notes} 便签 · {edges} 线",
  "notes.clue.boards.hoverNotes": "便签数",
  "notes.clue.boards.hoverEdges": "线的数",
  "notes.clue.boards.hoverActivity": "近期编辑",
  "notes.clue.boards.hoverActivityEmpty": "暂无历史快照",
  "notes.clue.boards.hoverActivityLoading": "加载历史…",
...
const EN: StringTable = {
  ...
  "notes.colorTemp.btnTitle":
    "Color temp & backspace: your typed text (composer, user bubbles, clue notes)",
  "notes.colorTemp.title": "Color temp & backspace",
  "notes.colorTemp.desc":
    "Colors each character by key interval: fast is warm red, slow is cold blue. Backspaced characters can show in gray. Applies to the composer, your bubbles, and clue-board note bodies — not assistant replies.",
  ...
  "notes.colorTemp.backspaceToggle": "Show backspaces",
  "notes.colorTemp.backspaceToggleHint":
    "On shows deleted characters in gray; off keeps only remaining text. Glyphs still save.",
  ...
  "notes.clue.boards.renameHint": "Double-click to rename. Ctrl multi-select, Shift range, Ctrl+A all; Esc exits multi-select. Right-click for details or delete.",
  ...
  "notes.clue.boards.tileMeta": "{notes} notes · {edges} wires",
  "notes.clue.boards.hoverNotes": "Notes",
  "notes.clue.boards.hoverEdges": "Wires",
  "notes.clue.boards.hoverActivity": "Recent edits",
  "notes.clue.boards.hoverActivityEmpty": "No history snapshots yet",
  "notes.clue.boards.hoverActivityLoading": "Loading history…",
