...
const ZH: StringTable = {
  ...
  "settings.title": "设置",
  "settings.sub":
    "WinRecorder 采集、开机行为、数据存放位置、语言模型、滚动缩放与外观。健康与统计见「仪表盘」。",
...
const EN: StringTable = {
  ...
  "settings.sub":
    "WinRecorder capture, startup, data folder, language models, scroll/zoom, and appearance. Health and stats are on Dashboard.",
