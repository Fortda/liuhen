...
const ZH: StringTable = {
  ...
  "settings.update.desc":
    "从 GitHub Release 只换程序文件（写入 incoming 后替换 exe），不改 OmniDatabase。",
  ...
  "settings.update.confirm":
    "将下载并替换 OmniPlayer 与采集器。数据目录 OmniDatabase 不会被改动。完成后会退出并自动重启。继续？",
  ...
  "settings.update.launchCheck.desc": "每次启动安静检查一次；已是最新不会打扰。",
  "settings.update.launchCheck.switchTitle": "启动时检查更新",
  "settings.update.launchNewer": "有新版本 {latest}，可在设置里更新。",
...
const EN: StringTable = {
  ...
  "settings.update.desc":
    "Pull a GitHub Release and replace program files only (write incoming, then swap exes). OmniDatabase is not touched.",
  ...
  "settings.update.confirm":
    "This downloads and replaces OmniPlayer and the recorder. OmniDatabase will not be changed. The app will quit and relaunch. Continue?",
  "settings.update.confirmIncoming":
  ...
  "settings.update.launchCheck.desc":
    "Quietly check once each launch. No prompt if you are already current.",
  "settings.update.launchCheck.switchTitle": "Check for updates at launch",
  "settings.update.launchNewer":
    "Version {latest} is available — update from Settings.",
  ...
  "notes.activity.explore": "Explored",
  "notes.activity.edited": "Edited",
